...
class GtcMatrixTransformUnitTests: public testing::Test {

    public:

        inline static const char* LOGGER_ID = "GtcMatrixTransformUnitTests";
...
*/
TEST_F(GtcMatrixTransformUnitTests, test_identityMatrix_1) {
    try {
...
*    - https://www.opengl-tutorial.org/beginners-tutorials/tutorial-3-matrices
*/
TEST_F(GtcMatrixTransformUnitTests, test_rotate_1) {
    try {
        std::string testGroup = testing::UnitTest::GetInstance()->current_test_info()->test_suite_name();
        std::string testCase = testing::UnitTest::GetInstance()->current_test_info()->name();
        EXQUDENS_LOG_INFO(LOGGER_ID) << "bgn";
...
*    - https://www.opengl-tutorial.org/beginners-tutorials/tutorial-3-matrices
*/
TEST_F(GtcMatrixTransformUnitTests, test_lookAt_1) {
    try {
        std::string testGroup = testing::UnitTest::GetInstance()->current_test_info()->test_suite_name();
        std::string testCase = testing::UnitTest::GetInstance()->current_test_info()->name();
        EXQUDENS_LOG_INFO(LOGGER_ID) << "bgn";
...
*    - https://www.opengl-tutorial.org/beginners-tutorials/tutorial-3-matrices
*/
TEST_F(GtcMatrixTransformUnitTests, test_perspective_1) {
    try {
        std::string testGroup = testing::UnitTest::GetInstance()->current_test_info()->test_suite_name();
        std::string testCase = testing::UnitTest::GetInstance()->current_test_info()->name();
        EXQUDENS_LOG_INFO(LOGGER_ID) << "bgn";
        ...
        glm::vec4 expected = glm::vec4(0.905330f, 1.207107f, -0.101010f, 0.0f);
        EXQUDENS_LOG_INFO(LOGGER_ID) << "expected: " << glm::to_string(expected);
...
/*
*    @brief Cumulating transformations: the ModelViewProjection matrix
*    links:
*    - https://www.opengl-tutorial.org/beginners-tutorials/tutorial-3-matrices
*/
TEST_F(GtcMatrixTransformUnitTests, test_rotate_lookAt_perspective_1) {
    try {
        std::string testGroup = testing::UnitTest::GetInstance()->current_test_info()->test_suite_name();
        std::string testCase = testing::UnitTest::GetInstance()->current_test_info()->name();
        EXQUDENS_LOG_INFO(LOGGER_ID) << "bgn";
